...
urlpatterns = [
    ...
    path('run/<int:run_id>/issue-email/send/', views.run_send_issue_email, name='b2b_run_send_issue_email'),
    path('run/<int:run_id>/issue-email/skip/', views.run_skip_issue_email, name='b2b_run_skip_issue_email'),

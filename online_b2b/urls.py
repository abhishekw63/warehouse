...
urlpatterns = [
    ...
    path(
        "rules/template/<str:slug>/", views.MarketplaceTemplateView.as_view(), name="b2b_template"
    ),
    ...
    path(
        "item-master/<str:token>/confirm/",
        views.item_master_confirm,
        name="b2b_item_master_confirm",
    ),
    path(
        "item-master/<str:token>/discard/",
        views.item_master_discard,
        name="b2b_item_master_discard",
    ),
